...
function Post({posts}: Props) {
    ...
    <main>
        <Header />
        <img className='w-full h-40 object-cover' src={urlFor(posts.mainImage).url()!} alt="" />
        <article className='max-w-3xl mx-auto p-5'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <p className='font-extralight text-sm'>Blog post by <span className='text-green-600'>{posts.author.name}</span> - Published at {new Date(posts._createdAt).toLocaleString()}</p>
            </div>
            <div className='mt-10'>
                <PortableText 
